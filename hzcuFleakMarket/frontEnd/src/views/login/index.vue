  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" class="login-form" auto-complete="on" label-position="left">
      ...
      <el-form-item prop="username">
        ...
        <el-input ref="username" v-model="loginForm.username" placeholder="请输入ID" name="username" type="text" tabindex="1" auto-complete="on" />
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    if (response === true) {
      ...
      api.UserById(this.loginForm.username).then((response) => {
        sessionStorage.setItem("adminInfo", JSON.stringify(response));
        eventBus.$emit('login-success', response);
      })
    ...
    this.$message.error("登录出现异常，请稍后重试！");
  }
},
  },
}
